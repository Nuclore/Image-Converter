...
1. Place the images to be converted in the 'images' folder.
2. Run the main.py script.
3. Enter width, height and format of the converted images.
4. The converted images should appear in the 'converted_images' folder.
